...
- `src/` runtime code
  - Telegram bridge modules now split into `main.py` (bootstrap/poll loop), `runtime_config.py`, `runtime_profile.py`, `handlers.py`, `transport.py`, `executor.py`, `state_store.py`, `session_manager.py`, `media.py`, `memory_engine.py`

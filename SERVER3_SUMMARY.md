...
- 2026-03-31: added a tracked static control-plane mockup at `docs/server3-control-plane-sketch.html` to pin the visual direction for a future Server3 operator UI: a dark mission-control layout with runtime rail, central live-activity timeline, right-side action drawer, approvals inbox, and bottom operator strip for host/storage/timer state.

...
- 2026-05-09: named the loop canonically as `Server3 Ralph Autopilot`, changed dirty-worktree handling so Ralph still runs and reports findings instead of refusing, added per-run Telegram updates, and added a daily Markdown report timer for this chat/topic.

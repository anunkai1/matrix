...
- 2026-03-31: added a standalone static `docs/projects/foodle.html` page for simple browser-local sugar/carbs/dairy streak tracking with one-tap daily logging, longest-streak summaries, a GitHub-style heatmap (26 weeks on desktop, 18 on phones) for month-scale streak visibility, phone-optimized layout tuning, a manual light/dark mode toggle with saved preference, darker high-contrast heatmap styling for dark mode readability, and mobile-friendly share-sheet/clipboard sharing for Wordle-style progress updates.

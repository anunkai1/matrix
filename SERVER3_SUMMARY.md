...
- 2026-03-22: added the first live CowSwap module to `mavali_eth` on Ethereum mainnet by introducing a dedicated CoW API client, parser/help wiring, helper-backed EIP-712 order signing, ETH-to-WETH wrap plus exact relayer approval on confirm, and live order posting/reconciliation; the first funded `WETH -> USDC` order from wallet `0xc88325e86fb245ecd41673043e63c2359b9e350c` is now posted on CoW as UID `0xd944d9b2fe37f57baf58ae6611e6a9459b1165e15524622381b510ba150282acc88325e86fb245ecd41673043e63c2359b9e350c69bfdf9d` with current status `open`.

...
- 2026-03-05: finalized explicit tone rule for daily Govorun 09:00 WhatsApp message in code + runbook: light/warm/enjoyable, exactly one short fun fact, prefer history/culture/animals/science/space/wholesome stories/life hacks, avoid heavy topics; fixed short format `Доброе утро...` + `Даю справку: ...`.

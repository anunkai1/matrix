...
- 2026-03-31: added a standalone static `docs/projects/foodle.html` page for simple browser-local sugar/carbs/dairy streak tracking with one-tap daily logging, seven-day visual history, longest-streak summaries, and mobile-friendly share-sheet/clipboard sharing for Wordle-style progress updates.

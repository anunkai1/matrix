...
- 2026-03-31: refined `docs/server3-control-plane-sketch.html` into a denser static Server3 operator mockup with a warm dark steel mission-control aesthetic, interactive runtime rail that repopulates the right-side detail drawer, a single cross-channel activity spine, explicit approvals inbox controls, jobs/schedules lane, and a persistent storage/host floor designed to stay open all day on desktop while remaining usable on phone.

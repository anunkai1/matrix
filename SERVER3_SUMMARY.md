...
- 2026-04-20/21: updated Foodle in `docs/projects/foodle.html` so the combined calendar starts weeks on Monday, share text includes the public URL, and the mobile tracker layout keeps the compact Fasting and Coffee cards side by side instead of making Fasting span the full row; the live Server2 Foodle HTML was republished after each change.

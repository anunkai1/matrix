...
- 2026-03-18: removed the explicit default reply-length line from the live Govorun runtime policy at `/home/govorun/govorunbot/AGENTS.md`, leaving the rest of the chat-first policy intact so response length is no longer pinned there.

...
- 2026-03-18: replaced the Govorun WhatsApp 09:00 daily message rotation with a local Reddit-backed cache of highly popular `r/LifeProTips` posts from the last 5 years plus persistent anti-repeat SQLite history, and updated the sender/runbook/env template so the message adapts cached source posts into Russian instead of inventing life hacks from scratch.

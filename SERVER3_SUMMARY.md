...
- 2026-04-20: updated Foodle's combined calendar in `docs/projects/foodle.html` so the weekday rail and week columns start on Monday instead of Sunday; the active-day highlight now uses the matching Monday-first weekday index, and the live Server2 Foodle HTML was republished.

...
class TestPlugins(unittest.TestCase):
    ...
    def test_load_config_defaults_plugin_selection(self):
        ...
        self.assertEqual(config.engine_plugin, "pi")
        self.assertEqual(config.selectable_engine_plugins, ["pi", "codex", "gemma"])
        self.assertEqual(config.gemma_provider, "ollama_ssh")
        self.assertEqual(config.gemma_model, "gemma4:26b")
        self.assertEqual(config.pi_provider, "minimax")
        self.assertEqual(config.pi_model, "minimax-m3")

...
def build_bridge_state_paths(state_dir: str) -> Dict[str, str]:
    return {
        ...
        "chat_pi_thinking_levels": os.path.join(state_dir, "chat_pi_thinking_levels.json"),
        "chat_streaming_enabled": os.path.join(state_dir, "chat_streaming_enabled.json"),
...
def load_bridge_state_mappings(state_paths: Dict[str, str]) -> Dict[str, Dict[object, object]]:
    state_specs = (
        ...
        ("pi_thinking_levels", "chat_pi_thinking_levels", load_chat_pi_thinking_levels, "chat Pi thinking level mappings"),
        ("streaming_enabled", "chat_streaming_enabled", load_chat_streaming_enabled, "chat streaming opt-in mappings"),

...
def build_help_text(config) -> str:
    ...
    minimal = (
        ...
        "/stream - show progressive streaming status for this chat\n"
        "/stream on|off - opt this chat in or out of progressive streaming\n"
        "/stream reset - clear this chat's streaming override\n"

...
def build_runtime_bootstrap(config: Config) -> RuntimeBootstrap:
    ...
    loaded_gemma_models = loaded_state.get("gemma_models", {})
    loaded_codex_models = loaded_state.get("codex_models", {})
    ...
    state = State(
        ...
        chat_gemma_model_path=state_paths.get("chat_gemma_models", ""),
        chat_codex_models=loaded_codex_models,
        chat_codex_model_path=state_paths.get("chat_codex_models", ""),
        chat_codex_efforts=loaded_codex_efforts,
        chat_codex_effort_path=state_paths.get("chat_codex_efforts", ""),

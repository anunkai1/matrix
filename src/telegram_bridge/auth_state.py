...
def clear_loaded_thread_state(
    ...
    loaded_in_flight: Dict[ScopeKey, Dict[str, object]],
    ...
    cleared_in_flight_count = len(loaded_in_flight)
    ...
    return {
        ...
        "in_flight_requests": cleared_in_flight_count,
...
def clear_runtime_thread_state(state: State) -> Dict[str, int]:
    ...
    with state.lock:
        ...
        cleared_in_flight_count = len(state.in_flight_requests)

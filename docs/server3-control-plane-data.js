window.SERVER3_CONTROL_PLANE_DATA = {
  "generatedAt": "2026-03-31T22:37:54.855308+10:00",
  ...
  "activity": [
    ...
    },
    {
      ...
      "statusClass": "ok",
      "statusText": "healthy",
      "copy": "2026-03-31 22:37:40,497 INFO 127.0.0.1 - \"GET /updates?offset=0&timeout=0 HTTP/1.1\" 200 -"
    },
    {
      "time": "21:15:04",
    ...
    },
    {
      ...
      "statusClass": "busy",
      "statusText": "attached",
      "copy": "snapshot | server3-browser-brain"
    },
    {
      "time": "20:02:14",
  ...
  "jobs": [
    ...
    },
    {
      ...
      "body": "mavali-eth-receipt-monitor.timer is active(waiting). Last trigger: 31 Mar 22:21."
    }
  ],
  "floor": [
    {
      ...
      "recentJobs": [
        {
          ...
          "value": "22:37:40 2026-03-31 22:37:40,497 INFO 127.0.0.1 - \"GET /updates?offset=0&timeout=0 HTTP/1.1\" 200 -"
        },
        {
      ...
      "recentJobs": [
        {
          ...
          "value": "20:31:04 snapshot | server3-browser-brain"
        }
      ],
      "watchouts": [
        {

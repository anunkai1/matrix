window.SERVER3_CONTROL_PLANE_DATA = {
  "generatedAt": "2026-05-21T09:38:24.090454+10:00",
  ...
  "activity": [
    ...
    },
    {
      ...
      "statusClass": "danger",
      "statusText": "degraded",
      "copy": "2026-05-21 09:40:25,884 INFO 127.0.0.1 - \"GET /updates?offset=0&timeout=0 HTTP/1.1\" 200 -"
    },
    {
      "time": "09:40:16",
  ...
  "jobs": [
    {
      ...
      "tagClass": "busy",
      "tagText": "21 May 09:45",
      "body": "server3-runtime-observer.timer is active(waiting). Last trigger: 21 May 09:40."
    },
    {
      "title": "Routing drift check",
      "tagClass": "busy",
      "tagText": "22 May 06:15",
      "body": "server3-chat-routing-contract-check.timer is active(waiting). Last trigger: 21 May 06:15."
    },
    {
      "title": "State backup",
      "tagClass": "busy",
  ...
  "floor": [
    ...
    },
    {
      ...
      "stateText": "watch",
      "value": "48% used",
      "body": "/srv/external/server3-arr | 864 GiB free of 1833 GiB",
    ...
    },
    {
      ...
      "body": "37% used | 280 GiB free of 480 GiB",
      ...
      "recentJobs": [
        {
          ...
          "value": "09:38:18 Started telegram-architect-bridge.service - Telegram Architect Bridge."
        }
      ],
      "watchouts": [
        {
      ...
      "recentJobs": [
        {
          ...
          "value": "09:38:18 Started telegram-tank-bridge.service - Telegram Tank Bridge."
        }
      ],
      "watchouts": [
        {
      ...
      "recentJobs": [
        {
          ...
          "value": "09:38:18 Started telegram-diary-bridge.service - Telegram Diary Bridge."
        }
      ],
      "watchouts": [
        {
      ...
      "recentJobs": [
        {
          ...
          "value": "09:38:18 Started whatsapp-govorun-bridge.service - WhatsApp Govorun Bridge (Codex)."
        },
        {
          "label": "govorun-whatsapp-bridge.service",
          "value": "09:38:19 Started govorun-whatsapp-bridge.service - Govorun WhatsApp Bridge."
        }
      ],
      "watchouts": [
        {
      ...
      "recentJobs": [
        {
          ...
          "value": "09:38:17 Started signal-oracle-bridge.service - Signal Oracle Transport Bridge."
        },
        {
          "label": "oracle-signal-bridge.service",
          "value": "09:38:17 Starting oracle-signal-bridge.service - Oracle Signal Bridge..."
        }
      ],
      "watchouts": [
        {
      ...
      "recentJobs": [
        {
          ...
          "value": "09:38:18 Started telegram-mavali-eth-bridge.service - Telegram Mavali ETH Bridge."
        },
        {
          "label": "mavali-eth-receipt-monitor.timer",
          "value": "09:38:09 Started mavali-eth-receipt-monitor.timer - Poll for confirmed inbound ETH for mavali_eth."
        }
      ],
      "watchouts": [
        {

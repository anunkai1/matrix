window.SERVER3_CONTROL_PLANE_DATA = {
  "generatedAt": "2026-06-11T06:53:14.884572+10:00",
  ...
  "activity": [
    {
      ...
      "statusClass": "danger",
      "statusText": "degraded",
      "copy": "2026-06-11 06:53:14,195 WARNING Signal event stream failed: Signal SSE stream ended"
    },
    {
      "time": "06:53:07",
  ...
  "jobs": [
    {
      ...
      "tagClass": "busy",
      "tagText": "11 Jun 06:55",
      "body": "server3-runtime-observer.timer is active(waiting). Last trigger: 11 Jun 06:50."
    },
    {
      "title": "Routing drift check",
      "tagClass": "busy",
      "tagText": "12 Jun 06:15",
      "body": "server3-chat-routing-contract-check.timer is active(waiting). Last trigger: 11 Jun 06:15."
    },
    {
      "title": "State backup",
      "tagClass": "busy",
    ...
    },
    {
      ...
      "body": "mavali-eth-receipt-monitor.timer is active(waiting). Last trigger: 11 Jun 06:47."
    }
  ],
  "floor": [
    {
    ...
    },
    {
      ...
      "body": "14% used | 390 GiB free of 480 GiB",
      ...
      "recentJobs": [
        {
          ...
          "value": "16:49:33 Started whatsapp-govorun-bridge.service - WhatsApp Govorun Bridge (Codex)."
        },
        {
          "label": "govorun-whatsapp-bridge.service",
          "value": "06:53:14 Started govorun-whatsapp-bridge.service - Govorun WhatsApp Bridge."
        }
      ],
      "watchouts": [
        {
      ...
      "recentJobs": [
        {
          ...
          "value": "06:53:14 2026-06-11 06:53:14,195 WARNING Signal event stream failed: Signal SSE stream ended"
        },
        {
          "label": "oracle-signal-bridge.service",
          "value": "06:53:14 Starting oracle-signal-bridge.service - Oracle Signal Bridge..."
        }
      ],
      "watchouts": [
        {
      ...
      "recentJobs": [
        {
          ...
          "value": "23:11:24 bridge.request_processing_finished"
        },
        {

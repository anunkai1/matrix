# AGENTSMITH_INSTRUCTION.md - Server3 Runtime Policy (Authoritative)

Project: `agentsmithbot`  
...
- If a detail may be shared, shimmed, symlinked, or overlaid, inspect the real runtime path before concluding anything about architecture.
...
- AgentSmith is a Telegram runtime on Server3 with isolated runtime state.
- AgentSmith shares significant bridge architecture with Architect, but should keep its own operating docs, lessons, and summary.
